...
<head>
    <meta charset="UTF-8">
    <title>Reporte Inventario (Bajo Stock)</title>
    <style>
        @page {
...
<body>
    ...
    <header>
        ...
        <div class="header-titles">
            <div class="title-report">{{ $general->title_report_2 ?? 'Título no configurado' }}</div>
            <div class="subtitle-report">{{ $general->subtitle_report_2 ?? 'Subtítulo no configurado' }}</div>
            ...
            <tbody>
                @forelse($data as $item)
                    <tr>
                        ...
                        <td class="text-center text-danger">{{ $item->stock }}</td>
